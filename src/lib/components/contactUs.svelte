<script lang="ts">
    ...
    const agents: Item[] = [
        { title: "SEO Agent", description: "AI-powered search optimization", icon: "search", color: "text-blue-400" },
        { title: "Reddit Agent", description: "Targeted growth campaigns", icon: "reddit", color: "text-orange-400" },
        { title: "X Agent", description: "Coming soon: Engage on X", icon: "twitter", color: "text-gray-400" }
    ];
    
    // Other Benefits
    const otherBenefits: Item[] = [
        { title: "Brand Matching", description: "Replicates your voice", icon: "fa-microphone", color: "text-purple-400" },
        { title: "Business AI", description: "Tailored strategies", icon: "fa-lightbulb", color: "text-yellow-400" },
        { title: "Integrations", description: "WordPress, APIs & more", icon: "fa-plug", color: "text-green-400" }
    ];
...
<div class="min-h-screen bg-gradient-to-br from-black to-zinc-950 text-white font-[Poppins] flex flex-col items-center justify-start pt-20 px-4 relative">
    ...
    <div bind:this={headerRef} class="text-center mb-12 max-w-4xl w-full relative">
        {#if isVisibleHeader}
            <h1 in:blur={{delay: 0, duration: 600}} class="text-5xl md:text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-zinc-300">
                Get in Touch
            </h1>
    ...
    <div bind:this={mainRef} class="w-full max-w-6xl grid md:grid-cols-2 gap-8">
        {#if isVisibleMain}
                    ...
                    <form class="space-y-4" on:submit={submitForm}>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    class="w-full bg-zinc-900/50 border border-zinc-700 rounded-lg px-4 py-2 text-white placeholder-zinc-500 focus:border-blue-500 transition-all {!nameValid && formData.name ? 'border-red-500' : ''}"
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    class="w-full bg-zinc-900/50 border border-zinc-700 rounded-lg px-4 py-2 text-white placeholder-zinc-500 focus:border-blue-500 transition-all {!emailValid && formData.email ? 'border-red-500' : ''}"
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                class="w-full bg-zinc-900/50 border border-zinc-700 rounded-lg px-4 py-2 text-white placeholder-zinc-500 focus:border-blue-500 transition-all {!messageValid && formData.message ? 'border-red-500' : ''}"
            ...
            <!-- Agents Card -->
            <div bind:this={agentsRef} in:blur={{delay: 200, duration: 600}} class="card p-6 md:col-span-1 relative">
                ...
                <div class="grid grid-cols-3 gap-4">
                    {#each agents as agent, i}
                        <div class="item-card flex flex-col items-center p-2 bg-zinc-900/30 rounded-xl border border-zinc-800/50">
                            <div class="mb-1">
                                {#if agent.icon === 'search'}
                                    <svg class="w-5 h-5 {agent.color}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-center mt-4 text-sm"><a href="/signup" class="text-blue-400 hover:text-blue-300">Try for free →</a></p>
            </div>

            <!-- Other Benefits Card -->
            <div bind:this={benefitsRef} in:blur={{delay: 300, duration: 600}} class="card p-6 md:col-span-1 relative">
            ...
            <!-- Features Card -->
            <div bind:this={featuresRef} in:blur={{delay: 400, duration: 600}} class="card p-6 md:col-span-1 relative">
                ...
                <div class="space-y-3">
                    {#each features as feature, i}
                        <div in:blur={{delay: 100 * i, duration: 600}} class="flex items-center gap-3 bg-zinc-900/30 rounded-lg p-3 border border-zinc-800/50">
            ...
            <!-- Stats Card -->
            <div bind:this={statsRef} in:blur={{delay: 500, duration: 600}} class="card p-6 md:col-span-1 relative">
                ...
                <div class="grid grid-cols-3 gap-3">
                    {#each stats as stat, i}
                        <div in:blur={{delay: 100 * i, duration: 600}} class="stat-card p-3 rounded-lg text-center">
                            <div class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r {stat.gradient}">{stat.value}</div>
    ...
    {#if loading}
        <div class="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
            <div class="card p-8 text-center">
                <div class="w-12 h-12 mx-auto mb-4 border-4 border-t-blue-500 rounded-full animate-spin"></div>
