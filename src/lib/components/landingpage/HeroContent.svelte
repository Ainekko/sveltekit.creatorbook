...
<div class="text-center mb-16 min-h-screen">
  <div bind:this={headlineRef} class="space-y-6 mb-12 relative">
    {#if isVisibleHeadline}
      ...
      <p in:blur={{delay: 200, duration: 600, amount: 5}} class="text-xl md:text-2xl text-zinc-500 max-w-3xl mx-auto leading-relaxed font-light">
        Automate 
        <svg class="inline w-5 h-5 text-zinc-950 align-middle mx-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="SEO">
        ...
        X, and 
        <svg class="inline w-5 h-5 text-zinc-950 align-middle mx-1" fill="currentColor" viewBox="0 0 24 24" aria-label="Reddit">
  ...
  <div bind:this={videoRef} class="mb-16 relative">
    {#if isVisibleVideo}
      <div in:blur={{delay: 0, duration: 600, amount: 5}} class="video-container max-w-4xl mx-auto relative">
        <video
