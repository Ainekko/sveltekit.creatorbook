...
<div class="text-center mb-16 min-h-screen">
	<div bind:this={headlineRef} class="space-y-6 mb-12 relative flex flex-col items-center">
		{#if isVisibleHeadline}
			...
			>
				Automate Reddit Growth & SEO with AI Agents
			</h1>
			...
			>
				Delegate the grunt work. Flowjoy's intelligent agents research trends, write optimized
				content, and engage communities 24/7. No complex workflows—just results.
			</h2>
		{/if}
	</div>
