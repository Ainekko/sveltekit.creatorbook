...
<div class="max-w-6xl mx-auto p-4">
  ...
  <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      {#each filteredPosts().linkedin as post, index}
          ...
          <div class="bg-zinc-900 rounded-lg border border-zinc-800 p-4 hover:border-purple-500/50 transition-colors">
              <!-- Header -->
              <div class="flex items-center justify-between mb-3">
                  <div class="flex items-center gap-2">
              ...
              <div class="flex gap-2 pt-3 border-t border-zinc-800">
                  ...
                  <button class="flex-1 py-2 bg-purple-900/30 hover:bg-purple-900/50 rounded text-xs text-purple-400 transition-colors">
                      Use Template
                  </button>
              </div>
          </div>
      ...
      {#each filteredPosts().reddit as post, index}
          ...
          <div class="bg-zinc-900 rounded-lg border border-zinc-800 p-4 hover:border-orange-500/50 transition-colors">
              <!-- Header -->
              <div class="flex items-center justify-between mb-3">
                  <div class="flex items-center gap-2">
              ...
              <div class="flex gap-2 pt-3 border-t border-zinc-800">
                  ...
                  <button class="flex-1 py-2 bg-orange-900/30 hover:bg-orange-900/50 rounded text-xs text-orange-400 transition-colors">
                      Use Template
                  </button>
              </div>
          </div>
