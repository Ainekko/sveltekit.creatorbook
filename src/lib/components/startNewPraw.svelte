<script lang="ts">
	...
	async function handleStartProject() {
		...
		try {
			...
			const savedProject = await saveProject(token, clientUrl, '', '', analysisResultData);
		...
		<div class="max-w-4xl mx-auto">
			{#if $isLoading}
				...
				<div class="bg-zinc-950 rounded-xl border border-zinc-800 p-12 text-center">
					<div
						class="inline-flex items-center justify-center w-16 h-16 bg-zinc-900 rounded-xl mb-6"
					>
						<svg
				...
				<div class="grid grid-cols-12 gap-8">
					...
					<div class="col-span-12 lg:col-span-7">
						<div class="bg-zinc-950 rounded-xl border border-zinc-800 p-8">
							...
							{#if $error}
								<div
									class="mt-4 p-3 bg-red-900/20 border border-red-800 text-red-300 rounded-lg text-sm"
					...
					<div class="col-span-12 lg:col-span-5 space-y-6">
						...
						<div class="bg-zinc-950 rounded-xl border border-zinc-800 p-6">
							...
							<div class="space-y-4">
								<div class="flex items-start gap-3">
									<div
										class="w-6 h-6 rounded-full bg-emerald-500 flex items-center justify-center text-white text-xs font-bold mt-1"
									>
										1
									</div>
									<div>
										...
										<p class="text-zinc-400 text-xs">
											AI performs basic website and business analysis
										</p>
									</div>
								</div>
								<div class="flex items-start gap-3">
									<div
										class="w-6 h-6 rounded-full bg-zinc-700 flex items-center justify-center text-white text-xs font-bold mt-1"
									>
										2
									</div>
									<div>
										...
										<p class="text-zinc-400 text-xs">
											Access your AI Command Center with available agents
										</p>
									</div>
								</div>
								<div class="flex items-start gap-3">
									...
									<div>
										...
										<p class="text-zinc-400 text-xs">
											Choose and use AI agents as needed from your dashboard
										</p>
									</div>
								</div>
							</div>
						...
						<div class="bg-zinc-950 rounded-xl border border-zinc-800 p-6">
							...
							<div class="space-y-3">
								<div class="flex items-center gap-3">
									<div
										class="w-8 h-8 bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-600 rounded-lg flex items-center justify-center text-white text-xs font-bold"
									>
										SEO
									</div>
									<div>
								...
								<div class="flex items-center gap-3">
									<div
										class="w-8 h-8 bg-gradient-to-r from-orange-400 via-red-500 to-pink-600 rounded-lg flex items-center justify-center text-white text-xs font-bold"
									>
										R
									</div>
									<div>
							...
							<div class="mt-4 p-3 bg-zinc-900 rounded-lg border border-zinc-800">
								<p class="text-zinc-400 text-xs">
									After analysis, interact with these AI agents from your dashboard to generate
									targeted content and strategies.
								</p>
							</div>
						</div>
						...
						<div class="bg-zinc-950 rounded-xl border border-zinc-800 p-6">
							...
							<div class="mt-3 p-3 bg-zinc-900 rounded-lg border border-zinc-800">
								<p class="text-zinc-400 text-xs">
									Quick setup gets you started. Deep analysis happens when you interact with
									specific AI agents in your dashboard.
								</p>
							</div>
						</div>
					</div>
