<script>
  ...
  // Available agent addons
  const agentAddons = [
      {
          id: 'find-leads',
          name: 'Find Leads',
          description: 'Discover potential customers and contact information',
          premium: true,
          icon: '👤'
      },
      {
          ...
          description: 'Advanced competitor research and positioning analysis',
          premium: true,
          icon: '🎯'
      },
      {
  ...
  function showTooltipFor(addonId) {
      ...
      setTimeout(() => showTooltip.set(''), 2000);
  }
...
<div class="min-h-screen w-full bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 p-6">
  <div class="max-w-3xl mx-auto">
      ...
      <div class="text-center mb-8">
          ...
          <p class="text-zinc-400 text-lg">
              Analyze your website and generate marketing content with AI
          </p>
      </div>

      <!-- Main Form Card -->
      <div class="bg-zinc-900/60 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-zinc-800/50 ring-1 ring-zinc-700/20">
          <form on:submit|preventDefault={handleAnalyzeWebsite} class="space-y-8">
                  ...
                  <button 
                      ...
                      class="w-full relative px-8 py-4 text-base font-semibold rounded-xl shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 disabled:opacity-50 disabled:cursor-not-allowed
                          {$isLoading 
                              ...
                              : 'bg-gradient-to-r from-zinc-800 to-zinc-700 hover:from-zinc-700 hover:to-zinc-600 text-zinc-100 border border-zinc-600 hover:border-zinc-500 focus:ring-zinc-500 transform hover:scale-[1.02] active:scale-[0.98]'
                          }"
                      disabled={$isLoading}
                  >
                      {#if $isLoading}
                  ...
                  <div class="inline-flex flex-col items-center justify-center space-y-4 p-6 bg-zinc-800/30 rounded-xl border border-zinc-700/50 backdrop-blur-sm">
                      ...
                      <div class="space-y-2">
                          <p class="text-base font-medium text-zinc-200">
                              Analyzing your website and competitors...
                          </p>
                      ...
                      <div class="flex items-center space-x-2 mt-4">
                          ...
                          <div class="flex items-center space-x-1">
                              ...
                              <span class="text-xs text-zinc-500">Competitor Research</span>
                          </div>
                          <div class="w-1 h-1 bg-zinc-600 rounded-full"></div>
                          <div class="flex items-center space-x-1">
                              <div class="w-2 h-2 bg-zinc-600 rounded-full"></div>
                              <span class="text-xs text-zinc-500">Content Generation</span>
                          </div>
                      </div>
                  </div>
              </div>
