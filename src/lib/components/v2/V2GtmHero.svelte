    ...
    {#if mounted}
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div class="flex flex-col">
          ...
          >
            We build the machinery that sells your product — <strong class="font-medium text-zinc-700">prospecting infrastructure, lead intelligence, AI agents, and outbound systems</strong> — so your core engineers stay focused on the roadmap.
          </p>
          ...
          >
            {#each ['MVP in 2–4 weeks', 'You own the code', 'Integrated into your stack'] as item}
