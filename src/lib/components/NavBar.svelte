...
<nav
	class="w-full font-[Poppins] sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-zinc-100 shadow-sm"
>
...
{#if isMenuOpen}
	<div
		class="lg:hidden fixed inset-x-0 top-16 z-40 bg-white/95 backdrop-blur-xl shadow-lg border-b border-zinc-100 max-h-[calc(100vh-4rem)] overflow-y-auto"
	>
