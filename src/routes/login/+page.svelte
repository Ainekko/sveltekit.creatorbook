<script>
  ...
  <div class="bg-inherit h-screen md:h-screen w-max[1440px] flex flex-col md:flex-row gap-5 md:gap-10 justify-center md:justify-evenly items-center  w-full pt-10 md:pt-0">

    <div class="h-auto  max-w-[1200px] flex justify-center items-center overflow-hidden md:flex-auto w-full">
