  ...
  <div class="w-full max-w-md px-4 z-10">
      <div in:fade={{ duration: 300, delay: 150 }} class="flex flex-col bg-zinc-900/80 backdrop-blur-md border border-zinc-800 shadow-2xl shadow-violet-900/20 rounded-2xl p-8">
          <div class="mb-6 text-center">
              <h1 class="text-2xl font-bold bg-gradient-to-r from-violet-400 via-pink-400 to-violet-400 text-transparent bg-clip-text">Welcome Back</h1>
              <p class="text-zinc-400 text-sm mt-1">Log in to your account</p>
          </div>
          ...
          <div class="text-center mt-6 text-zinc-400">
              ...
              <a href="/signup" class="font-medium text-violet-400 hover:text-violet-300 transition-colors">Sign up</a>
          </div>
      </div>
  </div>
