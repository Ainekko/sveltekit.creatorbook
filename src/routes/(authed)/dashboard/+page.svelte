...
<div class="min-h-[70vh] w-auto pl-5 pt-5">
  <div class="min-w-32 min-h-32 flex flex-row justify-between bg-zinc-900 p-4 rounded-xl">
    ...
    <div>
      <p class="font-mono text-zinc-400">22-05-2024</p>
    </div>
